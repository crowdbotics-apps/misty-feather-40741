"""
Django settings for misty_feather_40741 project.
...
ROOT_URLCONF = 'misty_feather_40741.urls'
...
WSGI_APPLICATION = 'misty_feather_40741.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_feather_40741 API",
    "DESCRIPTION": "API documentation for misty_feather_40741 App",
    "VERSION": "v1",
}
